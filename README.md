# Developer Notes, How To's etc

## SAP

- [Development Environment Setup](https://github.com/aawa69/Notes/tree/main/SAP/Dev_Setup)
  - [VSCode (for UI5)](https://github.com/aawa69/Notes/tree/main/SAP/Dev_Setup/VSCode)
    - [Setup VSCode for CAP / UI5 Development](https://github.com/aawa69/Notes/blob/main/SAP/Dev_Setup/VSCode/setup-btp-and-ui5-in-vscode.md)
  - [Eclipse (for ABAP)](https://github.com/aawa69/Notes/tree/main/SAP/Dev_Setup/Eclipse)
    - [Setup Eclipse for SAP (ABAP) Development](https://github.com/aawa69/EclipseSetup)
    - [Setup SAP GUI for Java for use with SAP CAL ABAP AS](https://github.com/aawa69/Notes/blob/main/SAP/Dev_Setup/Eclipse/sap-gui-for-java-on-sap-cal-as-abap.md)  
